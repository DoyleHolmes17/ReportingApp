 ...
 */
public class RegisterAsyncTask extends AsyncTask<Object, Integer, Login> {
    private HashMap<String, String> hashMap;
    private Context context;

    public RegisterAsyncTask(Context context, HashMap<String, String> hashMap) {
    ...
    protected Login doInBackground(Object... objects) {
        ...
        String url = Urls.urlauth + Urls.register;
