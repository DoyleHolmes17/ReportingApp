 ...
 */
public class UpdateLaporanConfirmAsyncTask extends AsyncTask<Object, Integer, ListLaporan> {

    private Context context;
    private String header;
    private HashMap<String, String> hashMap;

    public UpdateLaporanConfirmAsyncTask(Context context, HashMap<String, String> hashMap, String header) {
    ...
    protected ListLaporan doInBackground(Object... objects) {
        ...
        String url = Urls.urllaporan + Urls.updatelaporanconfirmation;
