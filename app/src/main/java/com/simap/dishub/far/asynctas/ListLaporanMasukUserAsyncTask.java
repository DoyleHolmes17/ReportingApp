 ...
 */
public class ListLaporanMasukUserAsyncTask extends AsyncTask<Object, Integer, List<ListLaporan>> {

    private Context context;
    private String header, page;
    private HashMap<String, String> hashMap;

    public ListLaporanMasukUserAsyncTask(Context context, String header, String page) {
    ...
    protected List<ListLaporan> doInBackground(Object... objects) {
        ...
        String url = Urls.urllaporan + Urls.laporanusermasuk;
