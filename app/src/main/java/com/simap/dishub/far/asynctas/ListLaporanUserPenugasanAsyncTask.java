 ...
 */
public class ListLaporanUserPenugasanAsyncTask extends AsyncTask<Object, Integer, List<ListLaporan>> {

    private Context context;
    private String header, page;
    private HashMap<String, String> hashMap;

    public ListLaporanUserPenugasanAsyncTask(Context context, String header, String page) {
    ...
    protected List<ListLaporan> doInBackground(Object... objects) {
        ...
        String url = Urls.urllaporan + Urls.laporanuserpenugasan;
