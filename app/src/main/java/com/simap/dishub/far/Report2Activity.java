...
public class Report2Activity extends AppCompatActivity {
    private String TAG = Report2Activity.class.getSimpleName();

    private ProgressDialog pDialog;
    private ListView lv;

    // URL to get contacts JSON
    private static String url = "http://182.253.200.185/dishub2/index.php/c_report_progres";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Report2Activity.GetLaporan().execute();
    }
    ...
    private class GetLaporan extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Report2Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            final ListAdapter adapter = new SimpleAdapter(
                    Report2Activity.this, reportList,
                    R.layout.list_laporan_progres, new String[]{"area","alamat", "categorys","teknisi","start","pelapor", "note","noteadmin",
                    "status"}, new int[]{R.id.textareaInfra,R.id.textalamatInfra,R.id.textcategorysInfra,R.id.textteknisiInfra,R.id.textstartInfra,R.id.textpelaporInfra,
                    R.id.textnoteInfra,R.id.textnoteadminInfra, R.id.textstatusReport});
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    String noteadmin = (String) obj.get("noteadmin");

                    String categorys = (String) obj.get("categorys");
                    String teknisi = (String) obj.get("teknisi");
                    String start = (String) obj.get("start");
                    String alamat = (String) obj.get("alamat");
                    String pelapor = (String) obj.get("pelapor");
                    ...
                    intent.putExtra("noteadmin", noteadmin);

                    intent.putExtra("categorys", categorys);
                    intent.putExtra("teknisi", teknisi);
