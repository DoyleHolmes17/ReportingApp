...
import com.simap.dishub.far.asynctas.ListLaporanConfirmAsyncTask;
...
public class ListLaporanAdminOnConfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header = Utils.readSharedSetting(ListLaporanAdminOnConfActivity.this, "api_key", null);
        Log.e("header", header);
        ...
        if (statlistlap.equals("adminconfirm2")) {
            pages = "0";
            asyncconf(pages);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();
                Intent intent = new Intent(ListLaporanAdminOnConfActivity.this, Pegawai1Activity.class);
    ...
    protected void asyncconf(final String page) {
        ...
        new ListLaporanConfirmAsyncTask(this, header, page) {

            @Override
            protected void onPreExecute() {
                super.onPreExecute();
                // Showing progress dialog
                pDialog = new ProgressDialog(ListLaporanAdminOnConfActivity.this);
...
//                        Log.e("list >>>", templist + "");
                        pagei = temp + 1;
                        adapter = new RecyclerListLaporanConfAdapter(ListLaporanAdminOnConfActivity.this, templist);
                        ...
                        if (!templist.isEmpty()) {
                            ...
                            Toast.makeText(ListLaporanAdminOnConfActivity.this, "Data kosong.", Toast.LENGTH_LONG).show();
                        }
                        pagei = temp;
                    }
                } else {
                    ...
                    pagei = temp;
                    Toast.makeText(ListLaporanAdminOnConfActivity.this, "Tidak dapat terhubung ke internet.", Toast.LENGTH_LONG).show();
                }
                /**
