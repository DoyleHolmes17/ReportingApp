...
import com.simap.dishub.far.adapter.ImageAdapter2;
...
//                    txtMessage.setText(message);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    finish();
                    intent = new Intent(Menu1Activity.this, UploadActivity.class);
                    startActivity(intent);
                } else if (position == 1) {
                    finish();
                    Utils.saveSharedSetting(Menu1Activity.this, "statlistlap", "user");
                    intent = new Intent(Menu1Activity.this, ListLaporanActivity.class);
                    startActivity(intent);
                } else if (position == 2) {
                    finish();
                    session.setLogin(false);
                    Utils.saveSharedSetting(Menu1Activity.this, "jenisakun", "kosong");
                    intent = new Intent(Menu1Activity.this, LoginActivity.class);
                    startActivity(intent);
                }
            }
        });
    ...
    public void onBackPressed() {
        if (doubleBackToExitPressedOnce) {
            finish();
            Menu1Activity.this.finishAffinity();
