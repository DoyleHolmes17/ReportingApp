 ...
 */
public class DataReportStatusAsyncTask extends AsyncTask<Object, Integer, List<Report>> {

    private Context context;
    private String header;
    private HashMap<String, String> hashMap;

    public DataReportStatusAsyncTask(Context context, String header) {
    ...
    protected List<Report> doInBackground(Object... objects) {
        ...
        String url = Urls.urlmas + Urls.reportstatusmasuk;
