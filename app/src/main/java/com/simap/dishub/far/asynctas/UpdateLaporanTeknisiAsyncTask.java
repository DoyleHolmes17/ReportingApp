 ...
 */
public class UpdateLaporanTeknisiAsyncTask extends AsyncTask<Object, Integer, ListLaporan> {

    private Context context;
    private String header;
    private HashMap<String, String> hashMap;

    public UpdateLaporanTeknisiAsyncTask(Context context, HashMap<String, String> hashMap, String header) {
    ...
    protected ListLaporan doInBackground(Object... objects) {
        ...
        String url = Urls.urllaporan + Urls.updatefollowupteknisi;
