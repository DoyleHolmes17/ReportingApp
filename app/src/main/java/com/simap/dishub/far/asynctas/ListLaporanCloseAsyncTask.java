 ...
 */
public class ListLaporanCloseAsyncTask extends AsyncTask<Object, Integer, List<ListLaporan>> {

    private Context context;
    private String header, page;
    private HashMap<String, String> hashMap;

    public ListLaporanCloseAsyncTask(Context context, String header, String page) {
    ...
    protected List<ListLaporan> doInBackground(Object... objects) {
        ...
        String url = Urls.urllaporan + Urls.laporanteknisiclose;
...
//                        String sub_category_infra = jsonObject.has(FieldName.SUB_CATEGORY_INFRA) ? jsonObject.getString(FieldName.SUB_CATEGORY_INFRA) : "";
                        ...
                        String laporan_close = jsonObject.has(FieldName.LAPORAN_CLOSE) ? jsonObject.getString(FieldName.LAPORAN_CLOSE) : "";
                        String total_downtime = jsonObject.has(FieldName.TOTAL_DOWNTIME) ? jsonObject.getString(FieldName.TOTAL_DOWNTIME) : "";
                        ...
                        laporan.setLaporan_close(laporan_close);
                        laporan.setTotal_downtime(total_downtime);
