 ...
 */
public class ListLaporanProgresAsyncTask extends AsyncTask<Object, Integer, List<ListLaporan>> {

    private Context context;
    private String header, page;
    private HashMap<String, String> hashMap;

    public ListLaporanProgresAsyncTask(Context context, String header, String page) {
    ...
    protected List<ListLaporan> doInBackground(Object... objects) {
        ...
        String url = Urls.urllaporan + Urls.laporanteknisiprogress;
        ...
        if (result != null) {
            try {
                ...
                String data = reader.has(FieldName.DATA) ? reader.getString(FieldName.DATA) : "";
                if (!data.equals("[]")) {
                    Log.e("if", data + "");
