...
import com.simap.dishub.far.asynctas.ListLaporanProgresAsyncTask;
...
public class ListLaporanAdminFollowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header = Utils.readSharedSetting(ListLaporanAdminFollowActivity.this, "api_key", null);
        Log.e("header", header);
        ...
        if (statlistlap.equals("adminconfirm")) {
            pages = "0";
            asyncconf(pages);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();
                Intent intent = new Intent(ListLaporanAdminFollowActivity.this, Pegawai1Activity.class);
    ...
    protected void asyncconf(final String page) {
        ...
        new ListLaporanProgresAsyncTask(this, header, page) {

            @Override
            protected void onPreExecute() {
                super.onPreExecute();
                // Showing progress dialog
                pDialog = new ProgressDialog(ListLaporanAdminFollowActivity.this);
            ...
            protected void onPostExecute(List<ListLaporan> listLaporan) {
                ...
                if (pDialog.isShowing())
                    pDialog.dismiss();
//                Log.e("listlap", listLaporan + "");
                if (!listLaporan.isEmpty()) {
                    if (listLaporan.get(0).getStatus().equals("true")) {
                        templist.addAll(listLaporan);
//                        Log.e("list >>>", templist + "");
                        pagei = temp + 1;
                        adapter = new RecyclerListLaporanAdminAdapter(ListLaporanAdminFollowActivity.this, templist);
                        ...
                        if (!templist.isEmpty()) {
                            ...
                            Toast.makeText(ListLaporanAdminFollowActivity.this, "Data kosong.", Toast.LENGTH_LONG).show();
                        }
                        pagei = temp;
                    }
                } else {
                    ...
                    pagei = temp;
                    Toast.makeText(ListLaporanAdminFollowActivity.this, "Tidak dapat terhubung ke internet.", Toast.LENGTH_LONG).show();
                }
                /**
