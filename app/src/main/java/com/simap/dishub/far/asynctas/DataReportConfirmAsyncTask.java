 ...
 */
public class DataReportConfirmAsyncTask extends AsyncTask<Object, Integer, List<Report>> {

    private Context context;
    private String header;
    private HashMap<String, String> hashMap;

    public DataReportConfirmAsyncTask(Context context, String header) {
    ...
    protected List<Report> doInBackground(Object... objects) {
        ...
        String url = Urls.urlmas + Urls.reportstatusconfirmation;
