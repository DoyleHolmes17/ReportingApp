...
import com.simap.dishub.far.ReportAllConfirmActivity;
import com.simap.dishub.far.ReportAllDetailActivity;
import com.simap.dishub.far.ReportAllProgresActivity;
...
public class RecyclerListLaporanAdminAdapter extends RecyclerView.Adapter<RecyclerListLaporanAdminAdapter.ViewHolder> {
...
//    private TopUp cart;
    ...
    public RecyclerListLaporanAdminAdapter(Context mContext, List<ListLaporan> inputData) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (img_pelapor.equals("null") || img_pelapor.isEmpty()){
        ...
        holder.btnpelapor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (statlistlap.equals("all")){
                    Utils.saveSharedSetting(mContext, "tombolimage", "all");
                } else if (statlistlap.equals("penugasanprogress")){
                    Utils.saveSharedSetting(mContext, "tombolimage", "penugasanprogress");
                } else if (statlistlap.equals("adminconfirm")){
                    Utils.saveSharedSetting(mContext, "tombolimage", "adminconfirm");
                }
        ...
        if (statlistlap.equals("all")) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, ReportAllDetailActivity.class);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, ReportAllProgresActivity.class);
                    intent.putExtra(FieldName.ID_CATEGORY, idcat);
                    intent.putExtra(FieldName.ID_AREA, idarea);
                    intent.putExtra(FieldName.AREA_INFRA, area);
                    intent.putExtra(FieldName.NOTE_INFRA, noteinf);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, ReportAllConfirmActivity.class);
                    intent.putExtra(FieldName.ID_CATEGORY, idcat);
                    intent.putExtra(FieldName.ID_AREA, idarea);
                    intent.putExtra(FieldName.AREA_INFRA, area);
                    intent.putExtra(FieldName.NOTE_INFRA, noteinf);
